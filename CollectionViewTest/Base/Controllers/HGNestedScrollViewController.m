...
//    NSLog(@"%f",[self.segmentedPageViewController.titleView convertRect:self.segmentedPageViewController.titleView.bounds toView:window].origin.y);
    // 利用contentOffset处理内外层scrollView的滑动冲突问题
    if (mainOffsetY - criticalPointOffsetY >= FLT_EPSILON) {
        /*
         * 到达临界点：
         * 1.未吸顶状态 -> 吸顶状态
