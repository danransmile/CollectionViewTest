...
- (void)setupPageViewControllers {
    ...
    self.segmentedPageViewController.titleView.backgroundColor = [UIColor yellowColor];
    self.segmentedPageViewController.titleView.titles = titles;
    self.segmentedPageViewController.titleView.alignment = HGCategoryViewAlignmentLeft;
    self.segmentedPageViewController.titleView.originalIndex = self.selectedIndex;
    self.segmentedPageViewController.titleView.itemSpacing = 30;
}
